...
---
<div>
  <img data-src="https://api.star-history.com/svg?repos=luost26/academic-homepage&type=Date" class="lazy w-100 rounded-xl-top" src="{{ '/assets/images/placeholders/empty-300x200.png' | relative_url }}">
  <div class="card-body">
